...
{
    title: 'External Documente 4',
},]
const { Option } = Mentions;


class ExternalDocument extends React.Component<{ match }> {
                ...
                <Row gutter={[16, 16]}>
                    <Col xs={24} sm={24} md={10} lg={10}>
                        <div className="form-container ">
                            <Card>
                                <h1 className='document-title'>External Document number {this.props.match.params.id} for marketing department</h1>
